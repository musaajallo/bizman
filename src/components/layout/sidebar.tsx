    ...
    return [
      ...
      { label: "Projects", href: "/africs/projects", icon: FolderKanban, description: "Track and manage all projects" },
      {
        ...
        children: [
          ...
          { label: "Adjusting Entries", href: "/africs/accounting/adjusting-entries", icon: RefreshCcw, description: "Period-end accruals, deferrals, and reversing entries" },
          { label: "Bad Debts", href: "/africs/accounting/bad-debts", icon: TrendingDown, description: "Allowance for doubtful accounts, write-offs, and recoveries" },
